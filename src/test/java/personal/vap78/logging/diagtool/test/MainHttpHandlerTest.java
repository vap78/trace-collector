...
public class MainHttpHandlerTest extends AbstractHandlerTest {
  ...
  private RequestResponseHolder mockAccessWithSession() throws Exception {
    PowerMock.reset(MainHttpHandler.class, Session.class, TraceConfiguration.class);
    ...
    PowerMock.mockStaticPartialNice(Session.class, "getById");
    Session mockSession = EasyMock.createMock(Session.class);
    
    EasyMock.expect(Session.getById("abc123")).andReturn(mockSession);
    ...
    PowerMock.replay(Session.class, TraceConfiguration.class, File.class, MainHttpHandler.class);
    return toReturn;
  }
