...
public class StopTracesConsoleImpl extends BaseStartStopOperation implements StopTracesOperation {
  ...
  private GetLogsCommand getLogs;
  
  public StopTracesConsoleImpl(ConsoleSession session) {
  ...
  public void execute(TraceConfiguration configuration) {
    try {
      ...
      getLogs = new GetLogsCommand(session, logFileToDownload);
  ...
  public String getReportFileName() {
    return new File (getLogs.getLogStoreDirectory(), reportFileName).getAbsolutePath();
  }
